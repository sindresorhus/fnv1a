...
if (typeof(BigInt) == 'undefined') {
  console.log('BigInt not supported - skipping fnv1a.bigInt() tests');
} else {
  // Sanity check larger hashes against values from
  // https://fnvhash.github.io/fnv-calculator-online/

  strictEqual(bigInt('hello world', {size: 32}), BigInt('0xd58b3fa7'));
  strictEqual(bigInt('hello world', {size: 64}), BigInt('0x779a65e7023cd2e7'));
  strictEqual(bigInt('hello world', {size: 128}), BigInt('0x6c155799fdc8eec4b91523808e7726b7'));
  strictEqual(bigInt('hello world', {size: 256}), BigInt('0xecc3cf2e0edfccd3d87f21ec0883aad4db43eead66ce09eb4a97e04e1a184527'));
  strictEqual(bigInt('hello world', {size: 512}), BigInt('0x2b9c19ec56ccf98da0f227cc82bfaacbd8350928bd2ceacae7bc8aa13e747f5c43ca4e2e98fc25e94e4e805675545ee95a3b968c0acfaecb90aea2fdbcd4de0f'));
  strictEqual(bigInt('hello world', {size: 1024}), BigInt(''));
}
